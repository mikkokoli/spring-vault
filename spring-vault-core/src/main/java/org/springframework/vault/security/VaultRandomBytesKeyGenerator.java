 ...
 * @author Mark Paluch
 */
public class VaultRandomBytesKeyGenerator implements BytesKeyGenerator {
	...
	/**
	 * Creates a new {@link VaultRandomBytesKeyGenerator} initialized to generate {@link
	 * 32} random bytes.
	 *
	 * @param vaultOperations must not be {@literal null}.
	 */
	public VaultRandomBytesKeyGenerator(VaultOperations vaultOperations) {
		this(vaultOperations, 32);
	}

	/**
	 * Creates a new {@link VaultRandomBytesKeyGenerator} initialized to generate
	 * {@code length} random bytes.
	 *
	 * @param vaultOperations must not be {@literal null}.
	 * @param length number of random bytes to generate. Must be greater than zero.
	 */
	public VaultRandomBytesKeyGenerator(VaultOperations vaultOperations, int length) {
